...
<html lang="en">
	<head>
		<meta charset="utf-8">
		<meta name="description" content="@ffmpeg/ffmpeg CDN by jsDelivr - A free, fast, and reliable Open Source CDN for npm and GitHub">
		<meta name="viewport" content="width=device-width, initial-scale=1">
		<title>@ffmpeg/ffmpeg CDN by jsDelivr - A free, fast, and reliable Open Source CDN</title>
		<style>
			body {
	...
	<body>
		<div class="container">
			<div class="header">
				<h1>@ffmpeg/ffmpeg CDN files</h1>

				<a class="badge" href="https://www.jsdelivr.com/package/npm/@ffmpeg/ffmpeg" title="jsDelivr monthly hits">
					<img alt="jsDelivr monthly hits badge" src="https://data.jsdelivr.com/v1/package/npm/@ffmpeg/ffmpeg/badge">
				</a>
			</div>
			...
			<div class="path">
				<ol itemscope itemtype="https://schema.org/BreadcrumbList">
					<li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
						<span itemprop="name">@ffmpeg/ffmpeg@0.12.10</span>
						<meta itemprop="position" content="0">
					</li>
				</ol>

				<select class="versions select-css">
					<option value="@ffmpeg/ffmpeg@0.12.15">@ffmpeg/ffmpeg@0.12.15</option>
					<option value="@ffmpeg/ffmpeg@0.12.14">@ffmpeg/ffmpeg@0.12.14</option>
					<option value="@ffmpeg/ffmpeg@0.12.13">@ffmpeg/ffmpeg@0.12.13</option>
					<option value="@ffmpeg/ffmpeg@0.12.12">@ffmpeg/ffmpeg@0.12.12</option>
					<option value="@ffmpeg/ffmpeg@0.12.10">@ffmpeg/ffmpeg@0.12.10</option>
					<option value="@ffmpeg/ffmpeg@0.12.9">@ffmpeg/ffmpeg@0.12.9</option>
					<option value="@ffmpeg/ffmpeg@0.12.8">@ffmpeg/ffmpeg@0.12.8</option>
					<option value="@ffmpeg/ffmpeg@0.12.7">@ffmpeg/ffmpeg@0.12.7</option>
					<option value="@ffmpeg/ffmpeg@0.12.6">@ffmpeg/ffmpeg@0.12.6</option>
					<option value="@ffmpeg/ffmpeg@0.12.5">@ffmpeg/ffmpeg@0.12.5</option>
					<option value="@ffmpeg/ffmpeg@0.12.4">@ffmpeg/ffmpeg@0.12.4</option>
					<option value="@ffmpeg/ffmpeg@0.12.3">@ffmpeg/ffmpeg@0.12.3</option>
					<option value="@ffmpeg/ffmpeg@0.12.2">@ffmpeg/ffmpeg@0.12.2</option>
					<option value="@ffmpeg/ffmpeg@0.12.1">@ffmpeg/ffmpeg@0.12.1</option>
					<option value="@ffmpeg/ffmpeg@0.12.0">@ffmpeg/ffmpeg@0.12.0</option>
					<option value="@ffmpeg/ffmpeg@0.12.0-alpha.1">@ffmpeg/ffmpeg@0.12.0-alpha.1</option>
					<option value="@ffmpeg/ffmpeg@0.11.6">@ffmpeg/ffmpeg@0.11.6</option>
					<option value="@ffmpeg/ffmpeg@0.11.5">@ffmpeg/ffmpeg@0.11.5</option>
					<option value="@ffmpeg/ffmpeg@0.11.4">@ffmpeg/ffmpeg@0.11.4</option>
					<option value="@ffmpeg/ffmpeg@0.11.3">@ffmpeg/ffmpeg@0.11.3</option>
					<option value="@ffmpeg/ffmpeg@0.11.2">@ffmpeg/ffmpeg@0.11.2</option>
					<option value="@ffmpeg/ffmpeg@0.11.1">@ffmpeg/ffmpeg@0.11.1</option>
					<option value="@ffmpeg/ffmpeg@0.11.0">@ffmpeg/ffmpeg@0.11.0</option>
					<option value="@ffmpeg/ffmpeg@0.10.1">@ffmpeg/ffmpeg@0.10.1</option>
					<option value="@ffmpeg/ffmpeg@0.10.0">@ffmpeg/ffmpeg@0.10.0</option>
					<option value="@ffmpeg/ffmpeg@0.9.8">@ffmpeg/ffmpeg@0.9.8</option>
					<option value="@ffmpeg/ffmpeg@0.9.7">@ffmpeg/ffmpeg@0.9.7</option>
					<option value="@ffmpeg/ffmpeg@0.9.6">@ffmpeg/ffmpeg@0.9.6</option>
					<option value="@ffmpeg/ffmpeg@0.9.5">@ffmpeg/ffmpeg@0.9.5</option>
					<option value="@ffmpeg/ffmpeg@0.9.4">@ffmpeg/ffmpeg@0.9.4</option>
					<option value="@ffmpeg/ffmpeg@0.9.3">@ffmpeg/ffmpeg@0.9.3</option>
					<option value="@ffmpeg/ffmpeg@0.9.2">@ffmpeg/ffmpeg@0.9.2</option>
					<option value="@ffmpeg/ffmpeg@0.9.1">@ffmpeg/ffmpeg@0.9.1</option>
					<option value="@ffmpeg/ffmpeg@0.9.0">@ffmpeg/ffmpeg@0.9.0</option>
					<option value="@ffmpeg/ffmpeg@0.8.3">@ffmpeg/ffmpeg@0.8.3</option>
					<option value="@ffmpeg/ffmpeg@0.8.2">@ffmpeg/ffmpeg@0.8.2</option>
					<option value="@ffmpeg/ffmpeg@0.8.1">@ffmpeg/ffmpeg@0.8.1</option>
					<option value="@ffmpeg/ffmpeg@0.8.0">@ffmpeg/ffmpeg@0.8.0</option>
					<option value="@ffmpeg/ffmpeg@0.7.0">@ffmpeg/ffmpeg@0.7.0</option>
					<option value="@ffmpeg/ffmpeg@0.6.1">@ffmpeg/ffmpeg@0.6.1</option>
					<option value="@ffmpeg/ffmpeg@0.6.0">@ffmpeg/ffmpeg@0.6.0</option>
					<option value="@ffmpeg/ffmpeg@0.5.2">@ffmpeg/ffmpeg@0.5.2</option>
					<option value="@ffmpeg/ffmpeg@0.5.1">@ffmpeg/ffmpeg@0.5.1</option>
					<option value="@ffmpeg/ffmpeg@0.5.0">@ffmpeg/ffmpeg@0.5.0</option>
					<option value="@ffmpeg/ffmpeg@0.4.1">@ffmpeg/ffmpeg@0.4.1</option>
					<option value="@ffmpeg/ffmpeg@0.4.0">@ffmpeg/ffmpeg@0.4.0</option>
					<option value="@ffmpeg/ffmpeg@0.3.0">@ffmpeg/ffmpeg@0.3.0</option>
					<option value="@ffmpeg/ffmpeg@0.2.2">@ffmpeg/ffmpeg@0.2.2</option>
					<option value="@ffmpeg/ffmpeg@0.2.1">@ffmpeg/ffmpeg@0.2.1</option>
					<option value="@ffmpeg/ffmpeg@0.2.0">@ffmpeg/ffmpeg@0.2.0</option>
					<option value="@ffmpeg/ffmpeg@0.1.0">@ffmpeg/ffmpeg@0.1.0</option>
				</select>
			</div>
				...
				<table>
					...
					<tr>
						<td class="name">
							...
							<a rel="nofollow" href="/npm/@ffmpeg/ffmpeg@0.12.10/dist/">dist</a>
						</td>
						<td class="size"></td>
					</tr>
					<tr>
						<td class="name">
							...
							<a rel="nofollow" href="/npm/@ffmpeg/ffmpeg@0.12.10/package.json">package.json</a>
						</td>
						<td class="size">1.51 KB</td>
					</tr>
					</tbody>
				</table>
			</div>
			...
			<div class="landing">
				<p class="left">Free Open Source CDN for <strong>@ffmpeg/ffmpeg</strong></p>

				<p class="right">
					Looking for a nice landing page for your package?
					<a href="https://www.jsdelivr.com/package/npm/@ffmpeg/ffmpeg">https://www.jsdelivr.com/package/npm/@ffmpeg/ffmpeg</a>
				</p>
			</div>
		</div>
		...
		<script>
			...
			[].slice.call(versions.querySelectorAll('option')).forEach(function(option) {
				if (option.value === '@ffmpeg/ffmpeg@0.12.10') {
